# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_atanF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_atanF32.c"
# 30 "0_Src/1_SrvSw/DspLib/src/Ifx_atanF32.c"
...
# 31 "0_Src/1_SrvSw/DspLib/src/Ifx_atanF32.c" 2

static float32
Ifx_atanF32_ref (float32 x)
{
    int i;
    float32 y = 0.0f;
    float32 xn;
    ...
    for(i=1; xn>=1.1920928955078125e-7F; i+=4) {
        y += 1.0f/i*xn;
        xn *= x*x;
        y -= 1.0f/(i+2)*xn;
        xn *= x*x;
...
# 72 "0_Src/1_SrvSw/DspLib/src/Ifx_atanF32.c"
static float32
Ifx_atanF32_optimizedC (float32 x)
{
    float32 result;
    float32 x2 = x*x;
    if (x2<=1.0f) {

        result = x/(1.0f+0.28125f*x2);
    } else {
        if (x<-1.0f) {

            result = -(3.1415926535f*0.5f) - x/(x2+0.28125f);
        } else {
...
float32
Ifx_atanF32 (float32 x, enum Ifx_mode mode)
{
    switch (mode) {
