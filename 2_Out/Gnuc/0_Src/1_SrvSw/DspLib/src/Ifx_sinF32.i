# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sinF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sinF32.c"
# 28 "0_Src/1_SrvSw/DspLib/src/Ifx_sinF32.c"
...
# 29 "0_Src/1_SrvSw/DspLib/src/Ifx_sinF32.c" 2
...
Ifx_sinF32_ref (float32 x)
{
 ...
 result=x;
 term=x;
 for (i=3; ((copysignf(((term/result)),(1.0f)))) >= 1.1920928955078125e-7F; i+=2) {
