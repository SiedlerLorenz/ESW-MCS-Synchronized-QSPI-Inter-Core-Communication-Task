# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c"
# 27 "0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c"
...
# 28 "0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c" 2

static void
Ifx_maxRealF32_ref (struct Ifx_maxRealF32State * state)
{
    float32 * x = state->x;
    uint32 n = state->n;

 uint32 i;
 float32 ma = -(*(float32*)Ifx_internalInf);
...
void
Ifx_maxRealF32 (struct Ifx_maxRealF32State * state)
{
