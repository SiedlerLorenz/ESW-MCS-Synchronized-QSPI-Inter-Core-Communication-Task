# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sqrtF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sqrtF32.c"
# 29 "0_Src/1_SrvSw/DspLib/src/Ifx_sqrtF32.c"
...
# 30 "0_Src/1_SrvSw/DspLib/src/Ifx_sqrtF32.c" 2
...
Ifx_sqrtF32_ref (float32 a)
{
    ...
    if (a < 0.0f) {
        ...
        xn = (*(float32*)Ifx_internalNan);
    } else if (a == 0.0f) {
        xn = 0.0f;
    } else {
        xn = a;
        while (fabs ((xn*xn-a)/a) >= 2.0*1.1920928955078125e-7F) {
            xn = 0.5f * (xn + a/xn);
        }
    }
    return xn;
