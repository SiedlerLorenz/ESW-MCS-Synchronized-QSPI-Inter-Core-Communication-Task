# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c"
# 45 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c"
...
# 46 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c" 2
...
Ifx_kalman_ref (struct Ifx_kalmanState * state)
{
    ...
    float32 p_apr[n*n];
    float32 c_trp[m*n];
    float32 p_aprc_trp[n*m];
    float32 cp_aprc_trp[m*m];
    float32 denom[m*m];
    float32 denom_inv[m*m];
    float32 k[n*m];
    float32 cx_apr[m];
    float32 diff[m];
    float32 kdiff[n];
    ...
    for (i=0;i<(n*n);i++)
        p_apos[i] = p[i];
# 106 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c"
    {
        struct Ifx_mtxMulRealF32State state_step11 = {
            IFX_MODE_ALGORITHMIC,
...
# 180 "0_Src/1_SrvSw/DspLib/src/Ifx_kalman.c"
    {
...
void
Ifx_kalman (struct Ifx_kalmanState * state)
{
