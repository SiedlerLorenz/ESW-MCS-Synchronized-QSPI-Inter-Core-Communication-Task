# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteB.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteB.c"
# 9 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteB.c"
...
# 10 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteB.c" 2
# 22 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteB.c"
static void
...
Ifx_bmpWriteB (FILE * f, uint8 * data, uint32 width, uint32 height)
{
    ...
    assert (width <= 8*byte_width);
    assert (byte_width < 8*(width+31));
