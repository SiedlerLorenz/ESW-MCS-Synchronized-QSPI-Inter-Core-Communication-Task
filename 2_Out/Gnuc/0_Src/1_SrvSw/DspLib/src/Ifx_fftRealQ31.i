# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_fftRealQ31.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_fftRealQ31.c"
# 32 "0_Src/1_SrvSw/DspLib/src/Ifx_fftRealQ31.c"
...
# 33 "0_Src/1_SrvSw/DspLib/src/Ifx_fftRealQ31.c" 2
...
Ifx_fftRealQ31_ref (struct Ifx_fftRealQ31State * state)
{
 ...
 sint32 * x = state->x;
    ...
    sint32 c1=0x40000000;
    sint32 c2=0xc0000000;
...
# 81 "0_Src/1_SrvSw/DspLib/src/Ifx_fftRealQ31.c"
    for (i=1; i<n4; i++) {


     do { float32 phi = -(2.0f*3.1415926535f)*(float32)(i)/((float32)(n)); (twiddle).real = (sint32) (Ifx_cosF32(phi,IFX_MODE_ALGORITHMIC)*2147483647.0); (twiddle).imag = (sint32) (Ifx_sinF32(phi,IFX_MODE_ALGORITHMIC)*2147483647.0); } while(0);


     do { sint64 a; a = (sint64) (data[i].real) + (sint64) (data[n2-i].real); (h1.real) = (sint32)(a>>1); } while(0);
     do { sint64 a; a = (sint64) (c1) * (sint64) (h1.real); (h1.real) = (sint32)((a+(1<<30))>>31); } while(0);


     do { sint64 a; a = (sint64) (data[i].imag) - (sint64) (data[n2-i].imag); (h1.imag) = (sint32)(a>>1); } while(0);
     do { sint64 a; a = (sint64) (c1) * (sint64) (h1.imag); (h1.imag) = (sint32)((a+(1<<30))>>31); } while(0);



     do { sint64 a; a = (sint64) (data[i].imag) + (sint64) (data[n2-i].imag); (h2.real) = (sint32)(a>>1); } while(0);
     do { sint64 a; a = (sint64) (c1) * (sint64) (h2.real); (h2.real) = (sint32)((a+(1<<30))>>31); } while(0);


     do { sint64 a; a = (sint64) (data[i].real) - (sint64) (data[n2-i].real); (h2.imag) = (sint32)(a>>1); } while(0);
     do { sint64 a; a = (sint64) (c2) * (sint64) (h2.imag); (h2.imag) = (sint32)((a+(1<<30))>>31); } while(0);





     do { sint64 a; a = (sint64) (twiddle.real) * (sint64) (h2.real); (temp1) = (sint32)((a+(1<<30))>>31); } while(0);
     do { sint64 a; a = (sint64) (twiddle.imag) * (sint64) (h2.imag); (temp2) = (sint32)((a+(1<<30))>>31); } while(0);
     data[i].real = h1.real+temp1-temp2;


      do { sint64 a; a = (sint64) (twiddle.real) * (sint64) (h2.imag); (temp3) = (sint32)((a+(1<<30))>>31); } while(0);
      do { sint64 a; a = (sint64) (twiddle.imag) * (sint64) (h2.real); (temp4) = (sint32)((a+(1<<30))>>31); } while(0);
