...
.Ltext0:
	.align 1
	.type	Ifx_maxRealF32_ref, @function
Ifx_maxRealF32_ref:
.LFB0:
	.file 1 "0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c"
	.loc 1 31 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 24
...
.L2:
	...
	ret
.LFE0:
	.size	Ifx_maxRealF32_ref, .-Ifx_maxRealF32_ref
.section .rodata,"a",@progbits
.LC0:
	.string	"maxRealF32"
.section .text,"ax",@progbits
	.align 1
	.global	Ifx_maxRealF32
	.type	Ifx_maxRealF32, @function
Ifx_maxRealF32:
.LFB1:
	.loc 1 45 0
	mov.aa	%a14, %SP
...
.L9:
	.loc 1 51 0
	ld.a	%a4, [%a14] -12
	call	Ifx_maxRealF32_ref
	.loc 1 53 0
	ret
.LFE1:
	.size	Ifx_maxRealF32, .-Ifx_maxRealF32
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/1_SrvSw/DspLib/src/Ifx_maxRealF32.c"
