# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_convertRealQ15F32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_convertRealQ15F32.c"
# 27 "0_Src/1_SrvSw/DspLib/src/Ifx_convertRealQ15F32.c"
...
# 28 "0_Src/1_SrvSw/DspLib/src/Ifx_convertRealQ15F32.c" 2
...
Ifx_convertRealQ15F32 (struct Ifx_convertRealQ15F32State * state)
{
    ...
    for (i=0; i<n; i++)
        y[i] = (float32) (x[i]*(powf(2.0f,-15.0f)));
}
