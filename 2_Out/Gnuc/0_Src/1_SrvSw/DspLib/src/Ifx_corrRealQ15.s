...
.Ltext0:
	.align 1
	.type	Ifx_corrRealQ15_ref, @function
Ifx_corrRealQ15_ref:
.LFB0:
	.file 1 "0_Src/1_SrvSw/DspLib/src/Ifx_corrRealQ15.c"
	.loc 1 34 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 40
...
.L2:
	...
	ret
.LFE0:
	.size	Ifx_corrRealQ15_ref, .-Ifx_corrRealQ15_ref
.section .rodata,"a",@progbits
.LC0:
	.string	"corrRealF32"
.section .text,"ax",@progbits
	.align 1
	.global	Ifx_corrRealQ15
	.type	Ifx_corrRealQ15, @function
Ifx_corrRealQ15:
.LFB1:
	.loc 1 54 0
	mov.aa	%a14, %SP
...
.L8:
	.loc 1 60 0
	ld.a	%a4, [%a14] -12
	call	Ifx_corrRealQ15_ref
	.loc 1 62 0
	ret
.LFE1:
	.size	Ifx_corrRealQ15, .-Ifx_corrRealQ15
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/1_SrvSw/DspLib/src/Ifx_corrRealQ15.c"
