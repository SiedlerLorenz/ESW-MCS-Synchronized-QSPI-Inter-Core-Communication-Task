# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_cosF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_cosF32.c"
# 28 "0_Src/1_SrvSw/DspLib/src/Ifx_cosF32.c"
...
# 29 "0_Src/1_SrvSw/DspLib/src/Ifx_cosF32.c" 2
...
Ifx_cosF32_ref (float32 x)
{
    ...
    x = fmodf (x, (2.0f*3.1415926535f));

    result=1.0f;
    term=1.0f;
    for (i=2; ((copysignf(((term/result)),(1.0f)))) >= 1.1920928955078125e-7F; i+=2) {
...
float32 Ifx_cosF32_optimizedC(float32 x) {
 float32 result, sign = 1.0f, scale;
 float32 a, b;
 uint32 idx;


 x = (3.1415926535f*0.5f) - x;


 if (x > 3.1415926535f) {

  x = x - (int) ((x + 3.1415926535f) * 0.1591549430918f) * (2.0f*3.1415926535f);
 ...
 idx = (int) (x * (128.0 / (3.1415926535f*0.5f)));
 a = Ifx_sinTableF32[idx].a;
 b = Ifx_sinTableF32[idx].b;
 result = a * x + b;


 result = (copysignf((result),(sign)));
