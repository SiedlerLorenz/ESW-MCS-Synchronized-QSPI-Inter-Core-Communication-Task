# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c"
# 13 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c"
...
# 14 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c" 2
...
Ifx_imgGaussBlur_ref (struct Ifx_imgGaussBlurState * state)
{
    ...
    uint32 kernel_size = ((uint16)(sigma+1)<<1)+1;
    float32 kernelf[kernel_size*kernel_size];
    sint16 kernel[kernel_size*kernel_size];
    uint32 mid = kernel_size>>1;
    float32 scale;
    uint32 sum = 0;
    uint16 shift;
    ...
    scale = (float32)(1/kernelf[mid]);
# 56 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c"
...
# 75 "0_Src/1_SrvSw/DspLib/src/Ifx_imgGaussBlur.c"
    for (i=0; i<kernel_size*kernel_size; i++) {
        sum += kernel[i];
    }
