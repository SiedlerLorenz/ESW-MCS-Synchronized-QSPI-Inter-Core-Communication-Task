...
.Ltext0:
	.align 1
	.type	Ifx_sumRealF32_ref, @function
Ifx_sumRealF32_ref:
.LFB0:
	.file 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sumRealF32.c"
	.loc 1 31 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 24
...
.L2:
	...
	ret
.LFE0:
	.size	Ifx_sumRealF32_ref, .-Ifx_sumRealF32_ref
.section .rodata,"a",@progbits
.LC0:
	.string	"sumRealF32"
.section .text,"ax",@progbits
	.align 1
	.global	Ifx_sumRealF32
	.type	Ifx_sumRealF32, @function
Ifx_sumRealF32:
.LFB1:
	.loc 1 45 0
	mov.aa	%a14, %SP
...
.L6:
	.loc 1 51 0
	ld.a	%a4, [%a14] -12
	call	Ifx_sumRealF32_ref
	.loc 1 53 0
	ret
.LFE1:
	.size	Ifx_sumRealF32, .-Ifx_sumRealF32
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/1_SrvSw/DspLib/src/Ifx_sumRealF32.c"
