...
.Ltext0:
	.align 1
	.type	Ifx_sumRealQ31_ref, @function
Ifx_sumRealQ31_ref:
.LFB0:
	.file 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sumRealQ31.c"
	.loc 1 31 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 24
...
.L2:
	...
	ret
.LFE0:
	.size	Ifx_sumRealQ31_ref, .-Ifx_sumRealQ31_ref
.section .rodata,"a",@progbits
.LC0:
	.string	"sumRealQ31"
.section .text,"ax",@progbits
	.align 1
	.global	Ifx_sumRealQ31
	.type	Ifx_sumRealQ31, @function
Ifx_sumRealQ31:
.LFB1:
	.loc 1 45 0
	mov.aa	%a14, %SP
...
.L6:
	.loc 1 51 0
	ld.a	%a4, [%a14] -12
	call	Ifx_sumRealQ31_ref
	.loc 1 53 0
	ret
.LFE1:
	.size	Ifx_sumRealQ31, .-Ifx_sumRealQ31
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/1_SrvSw/DspLib/src/Ifx_sumRealQ31.c"
