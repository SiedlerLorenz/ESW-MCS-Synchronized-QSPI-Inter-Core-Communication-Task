...
.Ltext0:
	.align 1
	.type	Ifx_sumRealQ15_ref, @function
Ifx_sumRealQ15_ref:
.LFB0:
	.file 1 "0_Src/1_SrvSw/DspLib/src/Ifx_sumRealQ15.c"
	.loc 1 31 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 24
...
.L2:
	...
	ret
.LFE0:
	.size	Ifx_sumRealQ15_ref, .-Ifx_sumRealQ15_ref
.section .rodata,"a",@progbits
.LC0:
	.string	"sumRealQ15"
.section .text,"ax",@progbits
	.align 1
	.global	Ifx_sumRealQ15
	.type	Ifx_sumRealQ15, @function
Ifx_sumRealQ15:
.LFB1:
	.loc 1 44 0
	mov.aa	%a14, %SP
...
.L6:
	.loc 1 50 0
	ld.a	%a4, [%a14] -12
	call	Ifx_sumRealQ15_ref
	.loc 1 52 0
	ret
.LFE1:
	.size	Ifx_sumRealQ15, .-Ifx_sumRealQ15
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/1_SrvSw/DspLib/src/Ifx_sumRealQ15.c"
