# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteRGB.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteRGB.c"
# 9 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteRGB.c"
...
# 10 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteRGB.c" 2
# 22 "0_Src/1_SrvSw/DspLib/src/Ifx_bmpWriteRGB.c"
static void
...
Ifx_bmpWriteRGB (FILE * f, uint8 * data, uint32 width, uint32 height)
{
    ...
    assert (3*width <= byte_width);
    assert (byte_width < 3*width+4);
    ...
    put_uint16 (f, 24);
    put_uint32 (f, 0);
    put_uint32 (f, byte_width*height);
    put_sint32 (f, 1000);
    put_sint32 (f, 1000);
    put_uint32 (f, 0);
    put_uint32 (f, 0);
