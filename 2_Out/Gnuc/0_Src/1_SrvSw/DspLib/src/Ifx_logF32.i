# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_logF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_logF32.c"
# 27 "0_Src/1_SrvSw/DspLib/src/Ifx_logF32.c"
...
# 28 "0_Src/1_SrvSw/DspLib/src/Ifx_logF32.c" 2
...
Ifx_logF32_ref (float32 x)
{
 ...
 float32 Ifx_logF32_optimizedC(float32 x) {
  ...
  input.f = input.f - 1;
  result = (input.f-input.f*input.f*(c1-input.f*c2+input.f*input.f*(c3-input.f*c4+input.f*input.f*c5)))-k;
