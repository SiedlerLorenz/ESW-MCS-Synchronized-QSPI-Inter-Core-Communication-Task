# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_imgPrewitt.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_imgPrewitt.c"
# 14 "0_Src/1_SrvSw/DspLib/src/Ifx_imgPrewitt.c"
...
# 15 "0_Src/1_SrvSw/DspLib/src/Ifx_imgPrewitt.c" 2
...
Ifx_imgPrewitt (struct Ifx_imgPrewittState * state)
{
    ...
    sint16 gx_buffer[m*n];
    sint16 gy_buffer[m*n];
    sint16 gx_kernel[] = {
        -1, 0, 1,
        -1, 0, 1,
        -1, 0, 1
    ...
    for (y=0; y<n; y++)
        for (x=0; x<m; x++) {
            ...
            for (j=0; j<6; j++) {
                ...
                dst[y*m+x] = (dst[y*m+x] + z/dst[y*m+x]) >> 1;
            }
