# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_asinF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_asinF32.c"
# 29 "0_Src/1_SrvSw/DspLib/src/Ifx_asinF32.c"
...
# 30 "0_Src/1_SrvSw/DspLib/src/Ifx_asinF32.c" 2
...
Ifx_asinF32_ref (float32 x)
{
    ...
    if (x < -1.0f || 1.0f < x) {
        ...
        result = (*(float32*)Ifx_internalNan);
    } else {
        float32 term = x;
        result = x;
        for (i=3; term/(float32)i/result>=1.1920928955078125e-7F; i+=2) {
