# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_acosF32.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/1_SrvSw/DspLib/src/Ifx_acosF32.c"
# 29 "0_Src/1_SrvSw/DspLib/src/Ifx_acosF32.c"
...
# 30 "0_Src/1_SrvSw/DspLib/src/Ifx_acosF32.c" 2
...
Ifx_acosF32_ref (float32 x)
{
    ...
    if (x < -1.0f || 1.0f < x) {
        ...
        result = (3.1415926535f*0.5f) - Ifx_asinF32 (x, mode);
 ...
 if (x==1.0f) {
  ...
  return result;
    ...
    if (x<1.0f) {
     ...
     result = (3.1415926535f*0.5f) - result;
    } else {
        Ifx_error (IFX_ERR_ERROR,
                   "acos(%g): argument out of range [-1;1]\n", x);
        result = (*(float32*)Ifx_internalNan);
