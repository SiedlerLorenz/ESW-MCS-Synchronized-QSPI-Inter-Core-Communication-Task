...
.LFB310:
	.file 1 "0_Src/4_McHal/Tricore/Dsadc/Rdc/IfxDsadc_Rdc.h"
	.loc 1 585 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 8
...
.LCFI1:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getPeriodPerRotation
	mov	%d15, %d2
	.loc 1 593 0
	mov	%d2, %d15
	ret
...
.LCFI2:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getRawPosition
	mov	%d15, %d2
	.loc 1 599 0
	mov	%d2, %d15
	ret
...
.section .srodata,"as",@progbits
	.align 1
	.type	IfxDsadc_Rdc_GtmTimCfg, @object
	.size	IfxDsadc_Rdc_GtmTimCfg, 4
IfxDsadc_Rdc_GtmTimCfg:
	.byte	5
	.byte	0
	.zero	2
.section .text,"ax",@progbits
	.align 1
	.type	IfxDsadc_Rdc_calculateGroupDelay, @function
IfxDsadc_Rdc_calculateGroupDelay:
.LFB316:
	.file 2 "0_Src/4_McHal/Tricore/Dsadc/Rdc/IfxDsadc_Rdc.c"
	.loc 2 143 0
	mov.aa	%a14, %SP
.LCFI4:
	sub.a	%SP, 16
	...
	ret
.LFE316:
	.size	IfxDsadc_Rdc_calculateGroupDelay, .-IfxDsadc_Rdc_calculateGroupDelay
	.align 1
	.type	IfxDsadc_Rdc_calculateTimestampPeriod, @function
IfxDsadc_Rdc_calculateTimestampPeriod:
.LFB317:
	.loc 2 150 0
	mov.aa	%a14, %SP
.LCFI5:
	...
	ret
.LFE317:
	.size	IfxDsadc_Rdc_calculateTimestampPeriod, .-IfxDsadc_Rdc_calculateTimestampPeriod
	.align 1
...
.LCFI6:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getAbsolutePosition
	mov	%d15, %d2
	.loc 2 159 0
	mov	%d2, %d15
	ret
...
.LCFI7:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getDirection
	mov	%d15, %d2
	.loc 2 165 0
	mov	%d2, %d15
	ret
...
.LCFI8:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getOffset
	mov	%d15, %d2
	.loc 2 171 0
	mov	%d2, %d15
	ret
...
.LCFI9:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getPosition
	mov	%d15, %d2
	.loc 2 177 0
	mov	%d2, %d15
	ret
...
.LCFI10:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getRefreshPeriod
	mov	%d15, %d2
	.loc 2 183 0
	mov	%d2, %d15
	ret
...
.LCFI11:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_getResolution
	mov	%d15, %d2
	.loc 2 189 0
	mov	%d2, %d15
	ret
...
.LFE325:
	...
	.align 1
	.type	IfxDsadc_Rdc_getUpdatePeriod, @function
IfxDsadc_Rdc_getUpdatePeriod:
.LFB326:
	.loc 2 205 0
	mov.aa	%a14, %SP
.LCFI14:
	...
	ret
.LFE326:
	.size	IfxDsadc_Rdc_getUpdatePeriod, .-IfxDsadc_Rdc_getUpdatePeriod
	.align 1
...
.LCFI15:
	...
	ld.a	%a4, [%a14] -60
	ld.a	%a5, [%a14] -64
	call	IfxDsadc_Rdc_initHwChannels
	mov	%d15, %d2
	mov	%d2, %d15
	ld.b	%d15, [%a14] -1
	and	%d15, %d2
	...
	ld.a	%a4, [%a14] -60
	ld.a	%a5, [%a14] -64
	call	IfxDsadc_Rdc_initHwTimestamp
	.loc 2 222 0
	ld.a	%a4, [%a14] -60
	call	IfxDsadc_Rdc_getUpdatePeriod
	ld.w	%d15, [%a14] -60
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 116, %d3
	.loc 2 223 0
	ld.a	%a4, [%a14] -60
	call	IfxDsadc_Rdc_calculateGroupDelay
	ld.w	%d15, [%a14] -60
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 120, %d3
	...
	.loc 2 225 0
	ld.a	%a4, [%a14] -64
	call	IfxDsadc_Rdc_calculateTimestampPeriod
	ld.w	%d15, [%a14] -60
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 180, %d3
...
.LFE328:
	...
	.align 1
	.type	IfxDsadc_Rdc_initGtmTim, @function
IfxDsadc_Rdc_initGtmTim:
.LFB329:
	.loc 2 293 0
	mov.aa	%a14, %SP
.LCFI17:
...
.LBB42:
.LBB43:
	.file 3 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tim.h"
	.loc 3 354 0
	ld.w	%d15, [%a14] -8
	mov	%d2, %d15
	ld.w	%d15, [%a14] -12
...
.LBE42:
	...
	ret
.LFE329:
	.size	IfxDsadc_Rdc_initGtmTim, .-IfxDsadc_Rdc_initGtmTim
	.align 1
	.type	IfxDsadc_Rdc_initHwChannels, @function
IfxDsadc_Rdc_initHwChannels:
.LFB330:
	.loc 2 304 0
	mov.aa	%a14, %SP
.LCFI18:
...
.LBB44:
	...
	mov.a	%a2, %d15
	mov.a	%a3, %d2
		# #chunks=18, chunksize=8, remains=0
	lea	%a15, 18-1
	0:
	ld.d	%e4, [%a3+]8
	st.d	[%a2+]8, %e4
...
.L41:
	...
	.loc 2 344 0
	ld.a	%a4, [%a14] -212
	call	IfxDsadc_Rdc_startConversion
.L42:
	.loc 2 348 0
	ld.w	%d15, [%a14] -8
	mov.a	%a2, %d15
...
.LBE52:
	...
	ret
.LFE330:
	.size	IfxDsadc_Rdc_initHwChannels, .-IfxDsadc_Rdc_initHwChannels
	.align 1
	.type	IfxDsadc_Rdc_initHwTimestamp, @function
IfxDsadc_Rdc_initHwTimestamp:
.LFB331:
	.loc 2 361 0
	mov.aa	%a14, %SP
.LCFI19:
...
.LBB57:
.LBB58:
	.file 6 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu_Intrinsics.h"
	.loc 6 93 0
	ld.w	%d15, [%a14] -28
	mov.a	%a15, %d15
	ld.w	%d2, [%a15]0
...
.LBE59:
	...
	ret
.LFE331:
	.size	IfxDsadc_Rdc_initHwTimestamp, .-IfxDsadc_Rdc_initHwTimestamp
	.align 1
...
.LBB63:
.LBB64:
	.file 8 "./0_Src/4_McHal/Tricore/Dsadc/Std/IfxDsadc.h"
	.loc 8 629 0
	ld.w	%d2, [%a14] -8
	ld.w	%d15, [%a14] -12
	sh	%d15, %d15, 8
...
.LCFI22:
	...
	ld.w	%d15, [%a14] -4
	mov.a	%a4, %d15
	call	Ifx_AngleTrkF32_resetFaults
	.loc 2 422 0
	ret
.LFE334:
...
.LCFI23:
	...
	mov.a	%a4, %d15
	ld.w	%d4, [%a14] -8
	call	Ifx_AngleTrkF32_setOffset
	.loc 2 428 0
	ret
.LFE335:
...
.LCFI24:
	...
	mov.a	%a4, %d15
	ld.w	%d4, [%a14] -8
	call	Ifx_AngleTrkF32_setRefreshPeriod
	.loc 2 434 0
	ret
.LFE336:
...
.LCFI26:
	...
	.loc 2 475 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxDsadc_Rdc_setOffset
	addi	%d2, %d2, lo:IfxDsadc_Rdc_setOffset
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 72, %d3
	.loc 2 476 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxDsadc_Rdc_setRefreshPeriod
	addi	%d2, %d2, lo:IfxDsadc_Rdc_setRefreshPeriod
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 88, %d3
	.loc 2 477 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxDsadc_Rdc_getTurn
	addi	%d2, %d2, lo:IfxDsadc_Rdc_getTurn
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 48, %d3
	.loc 2 478 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxDsadc_Rdc_onEventA
	addi	%d2, %d2, lo:IfxDsadc_Rdc_onEventA
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 52, %d3
	.loc 2 481 0
...
.LBB69:
.LBB70:
	.file 9 "./0_Src/1_SrvSw/SysSe/Math/Ifx_AngleTrkF32.h"
	.loc 9 152 0
	ld.w	%d15, [%a14] -36
	mov.a	%a15, %d15
	ld.w	%d15, [%a15] 88
...
.Letext0:
	...
	.file 12 "./0_Src/1_SrvSw/StdIf/IfxStdIf.h"
	.file 13 "./0_Src/1_SrvSw/StdIf/IfxStdIf_Pos.h"
	.file 14 "./0_Src/1_SrvSw/SysSe/Math/Ifx_LowPassPt1F32.h"
	.file 15 "./0_Src/4_McHal/Tricore/_Impl/IfxSrc_cfg.h"
	.file 16 "./0_Src/4_McHal/Tricore/_Reg/IfxSrc_regdef.h"
	.file 17 "./0_Src/4_McHal/Tricore/_Impl/IfxCpu_cfg.h"
	.file 18 "./0_Src/4_McHal/Tricore/_Reg/IfxPort_regdef.h"
	.file 19 "./0_Src/4_McHal/Tricore/_Reg/IfxDsadc_regdef.h"
	.file 20 "./0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.h"
	.file 21 "./0_Src/4_McHal/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.h"
	.file 22 "./0_Src/4_McHal/Tricore/_Reg/IfxGtm_regdef.h"
	.file 23 "./0_Src/4_McHal/Tricore/_Impl/IfxGtm_cfg.h"
	.file 24 "./0_Src/4_McHal/Tricore/_PinMap/IfxGtm_PinMap.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/4_McHal/Tricore/Dsadc/Rdc/IfxDsadc_Rdc.c"
