...
{
    sint32 maxBRP = (0x3f) + 1;
    sint32 minBRP = 1;
    sint32 maxTSEG1 = (0xf) + 1;
    sint32 minTSEG1 = 3;
    sint32 maxTSEG2 = (0x7) + 1;
    sint32 minTSEG2 = 2;
...
# 649 "0_Src/4_McHal/Tricore/Multican/Std/IfxMultican.c"
...
void IfxMultican_Node_setFastBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    ...
    float32 bestError = 10000.0;
    boolean baudrateTooLow, baudrateTooHigh, samplepointNotSuitable;
# 815 "0_Src/4_McHal/Tricore/Multican/Std/IfxMultican.c"
    bestError = baudrate * 0.05;
...
void IfxMultican_Node_setNominalBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    sint32 maxBRP = (0x3f) + 1;
    sint32 minBRP = 1;
    sint32 maxTSEG1 = (0x3f) + 1;
    sint32 minTSEG1 = 3;
    sint32 maxTSEG2 = (0x1f) + 1;
    sint32 minTSEG2 = 2;
    sint32 maxTBAUD = maxTSEG1 + maxTSEG2 + 1;
    sint32 minTBAUD = 8;
    ...
    float32 bestError = 10000.0;
    boolean baudrateTooLow, baudrateTooHigh, samplepointNotSuitable;
# 979 "0_Src/4_McHal/Tricore/Multican/Std/IfxMultican.c"
    bestError = baudrate * 0.05;
