...
{
# 142 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    uint32 x = *seed;
    ...
    uint32 m = 0xfffffffb;
    uint32 result;
# 163 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
...
# 217 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    * seed = result;
...
{
# 372 "0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.c"
    uint8 reqslp;
    boolean retValue;
    IfxCpu_ResourceCpu index = IfxCpu_getIndex(cpu);
