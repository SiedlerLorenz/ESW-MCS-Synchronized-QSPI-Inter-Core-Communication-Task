...
.LFB203:
	.file 1 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tim.c"
	.loc 1 36 0
	mov.aa	%a14, %SP
.LCFI0:
	sub.a	%SP, 16
	...
	.loc 1 39 0
	ld.a	%a4, [%a14] -16
	call	IfxGtm_Tim_Ch_getCaptureClockSource
	st.w	[%a14] -4, %d2
	.loc 1 41 0
	ld.a	%a4, [%a14] -12
	ld.w	%d4, [%a14] -4
...
.LCFI2:
	...
	.loc 1 56 0
	ld.a	%a4, [%a14] -16
	call	IfxGtm_Tim_Ch_getFilterClockSource
	st.w	[%a14] -8, %d2
	.loc 1 58 0
	movh	%d15, hi:.L8
	addi	%d2, %d15, lo:.L8
...
.LCFI4:
	...
	.loc 1 91 0
	ld.a	%a4, [%a14] -16
	call	IfxGtm_Tim_Ch_getTimeoutClockSource
	st.w	[%a14] -4, %d2
	.loc 1 93 0
	ld.a	%a4, [%a14] -12
	ld.w	%d4, [%a14] -4
...
.Letext0:
	...
	.file 4 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm.h"
