...
void IfxGtm_Tom_Tgc_enableChannel(Ifx_GTM_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate)
{
    ...
    value = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (0));
...
{
    tgc->GLB_CTRL.U = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (16));
}
...
void IfxGtm_Tom_Tgc_setChannelForceUpdate(Ifx_GTM_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean resetEnabled)
{
    ...
    regEnable = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (0));
    regReset = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, resetEnabled, (16));
