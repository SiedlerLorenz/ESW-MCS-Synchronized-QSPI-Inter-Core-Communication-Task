...
# 44 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c"
...
void IfxGtm_Atom_Agc_enableChannel(Ifx_GTM_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate)
{
    ...
    value = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (0));
...
{
    agc->GLB_CTRL.U = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (16));
}
...
void IfxGtm_Atom_Agc_setChannelForceUpdate(Ifx_GTM_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean resetEnabled)
{
    ...
    regEnable = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (0));
    regReset = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, resetEnabled, (16));
...
void IfxGtm_Atom_Agc_setChannelsForceUpdate(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regReset = IfxGtm_Atom_Agc_buildFeature(resetEnableMask, resetDisableMask, (16));
