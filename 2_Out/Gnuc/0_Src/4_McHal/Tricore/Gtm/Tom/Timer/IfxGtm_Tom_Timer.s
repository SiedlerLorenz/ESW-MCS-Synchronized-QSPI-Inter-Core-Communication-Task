...
.LCFI9:
	...
	mov.a	%a4, %d2
	mov	%d4, %d15
	call	IfxGtm_Tom_Ch_getTimerPointer
	mov.aa	%a15, %a2
	.loc 1 148 0
	mov.aa	%a2, %a15
	ret
...
.LCFI12:
	...
	mov.a	%a4, %d2
	mov	%d4, %d15
	call	IfxGtm_Tom_Ch_getCompareOnePointer
	mov.aa	%a15, %a2
	.loc 1 166 0
	mov.aa	%a2, %a15
	ret
...
.LBB54:
	...
	.loc 4 256 0 is_stmt 1 discriminator 8
	ld.h	%d15, [%a14] -46
	and	%d2, %d15, 255
	ld.w	%d15, [%a14] -40
	and	%d2, %d2, 255
...
.LCFI18:
	...
	mov	%d4, %d2
	mov	%d5, %d15
	call	IfxGtm_Tom_Ch_setOneShotMode
	.loc 1 378 0
	ret
.LFE246:
...
.LCFI20:
	...
	.loc 1 395 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_getFrequency
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_getFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 4, %d3
	.loc 1 396 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_getPeriod
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_getPeriod
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 8, %d3
	.loc 1 397 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_getResolution
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_getResolution
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 12, %d3
	.loc 1 398 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_getTrigger
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_getTrigger
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 16, %d3
	.loc 1 399 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_setFrequency
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_setFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 20, %d3
	.loc 1 400 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_updateInputFrequency
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_updateInputFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 24, %d3
	.loc 1 401 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_applyUpdate
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_applyUpdate
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 28, %d3
	.loc 1 402 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_disableUpdate
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_disableUpdate
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 32, %d3
	.loc 1 403 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_getInputFrequency
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_getInputFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 36, %d3
	.loc 1 404 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_run
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_run
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 40, %d3
	.loc 1 405 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_setPeriod
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_setPeriod
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 44, %d3
	.loc 1 406 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_setSingleMode
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_setSingleMode
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 48, %d3
	.loc 1 407 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_setTrigger
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_setTrigger
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 52, %d3
	.loc 1 408 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_stop
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_stop
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 56, %d3
	.loc 1 409 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_acknowledgeTimerIrq
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_acknowledgeTimerIrq
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 60, %d3
	.loc 1 410 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Tom_Timer_acknowledgeTriggerIrq
	addi	%d2, %d2, lo:IfxGtm_Tom_Timer_acknowledgeTriggerIrq
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 64, %d3
	.loc 1 413 0
