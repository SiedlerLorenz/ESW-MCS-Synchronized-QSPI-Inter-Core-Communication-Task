...
# 34 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
...
void IfxGtm_Atom_Timer_addToChannelMask(IfxGtm_Atom_Timer *driver, IfxGtm_Atom_Ch channel)
{
    ...
    driver->agcDisableUpdate = IfxGtm_Atom_Agc_buildFeature(0, driver->channelsMask, (16));
    driver->agcApplyUpdate = IfxGtm_Atom_Agc_buildFeature(driver->channelsMask, 0, (16));
}
