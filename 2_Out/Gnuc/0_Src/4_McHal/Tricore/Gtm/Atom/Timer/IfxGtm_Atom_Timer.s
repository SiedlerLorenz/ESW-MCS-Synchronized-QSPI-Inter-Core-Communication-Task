...
.LCFI9:
	...
	mov.a	%a4, %d2
	mov	%d4, %d15
	call	IfxGtm_Atom_Ch_getTimerPointer
	mov.aa	%a15, %a2
	.loc 1 118 0
	mov.aa	%a2, %a15
	ret
...
.LCFI12:
	...
	mov.a	%a4, %d2
	mov	%d4, %d15
	call	IfxGtm_Atom_Ch_getCompareOnePointer
	mov.aa	%a15, %a2
	.loc 1 136 0
	mov.aa	%a2, %a15
	ret
...
.L40:
	...
	st.b	[%a14] -16, %d15
	.loc 1 244 0 is_stmt 1 discriminator 6
	ld.w	%d15, [%a14] -100
	mov.a	%a15, %d15
	ld.w	%d2, [%a15] 36
	ld.w	%d15, [%a14] -100
...
.LCFI18:
	...
	mov	%d4, %d2
	mov	%d5, %d15
	call	IfxGtm_Atom_Ch_setOneShotMode
	.loc 1 328 0
	ret
.LFE246:
...
.LCFI20:
	...
	.loc 1 345 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_getFrequency
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_getFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 4, %d3
	.loc 1 346 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_getPeriod
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_getPeriod
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 8, %d3
	.loc 1 347 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_getResolution
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_getResolution
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 12, %d3
	.loc 1 348 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_getTrigger
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_getTrigger
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 16, %d3
	.loc 1 349 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_setFrequency
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_setFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 20, %d3
	.loc 1 350 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_updateInputFrequency
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_updateInputFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 24, %d3
	.loc 1 351 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_applyUpdate
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_applyUpdate
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 28, %d3
	.loc 1 352 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_disableUpdate
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_disableUpdate
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 32, %d3
	.loc 1 353 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_getInputFrequency
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_getInputFrequency
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 36, %d3
	.loc 1 354 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_run
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_run
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 40, %d3
	.loc 1 355 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_setPeriod
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_setPeriod
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 44, %d3
	.loc 1 356 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_setSingleMode
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_setSingleMode
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 48, %d3
	.loc 1 357 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_setTrigger
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_setTrigger
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 52, %d3
	.loc 1 358 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_stop
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_stop
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 56, %d3
	.loc 1 359 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_acknowledgeTimerIrq
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_acknowledgeTimerIrq
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 60, %d3
	.loc 1 360 0
	ld.w	%d15, [%a14] -4
	movh	%d2, hi:IfxGtm_Atom_Timer_acknowledgeTriggerIrq
	addi	%d2, %d2, lo:IfxGtm_Atom_Timer_acknowledgeTriggerIrq
	mov	%d3, %d2
	mov.a	%a15, %d15
	st.w	[%a15] 64, %d3
	.loc 1 363 0
