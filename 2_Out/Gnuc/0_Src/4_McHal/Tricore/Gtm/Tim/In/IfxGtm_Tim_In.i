# 1 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c"
# 29 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c"
# 1 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h" 1
# 41 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
...
# 53 "./0_Src/4_McHal/Tricore/_Impl/IfxGtm_cfg.h" 2
...
# 42 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h" 2

# 1 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Cmu.h" 1
# 44 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h" 2
...
# 39 "./0_Src/4_McHal/Tricore/_PinMap/IfxScu_PinMap.h"
typedef const struct
{
    Ifx_SCU* module;
    IfxPort_Pin pin;
...
# 45 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h" 2
# 55 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
typedef enum
{
...
# 82 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
typedef struct
{
    boolean irqOnNewVal;
...
# 167 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
...
# 215 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
...
# 30 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c" 2
...
# 32 "0_Src/4_McHal/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c" 2
...
boolean IfxGtm_Tim_In_init(IfxGtm_Tim_In *driver, const IfxGtm_Tim_In_Config *config)
{
    ...
    config->gtm->TIM[timIndex].IN_SRC.U = 1 << ((2) + channelIndex * ((6) - (2)));

    switch (input)
    {
    case IfxGtm_Tim_In_Input_currentChannel:
        config->gtm->TIM[timIndex].IN_SRC.U = 1 << ((0) + channelIndex * ((4) - (0)));
    ...
    case IfxGtm_Tim_In_Input_aux:
        config->gtm->TIM[timIndex].IN_SRC.U = 2 << ((0) + channelIndex * ((4) - (0)));
        break;
    }
        ...
        || (config->filter.risingEdgeMode != IfxGtm_Tim_In_ConfigFilterMode_none))
    {
        ...
        else if (fallingfilterTime > (0xffffff))
        {
            fallingfilterTime = (0xffffff);
            result = 0;
        }
        ...
        else if (risingfilterTime > (0xffffff))
        {
            risingfilterTime = (0xffffff);
            result = 0;
        }
