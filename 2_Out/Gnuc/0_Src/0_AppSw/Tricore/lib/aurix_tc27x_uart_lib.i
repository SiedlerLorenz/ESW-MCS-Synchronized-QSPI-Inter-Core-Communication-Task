# 1 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
# 17 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""asclin1RxISR"",""0"",""8" );extern void __attribute__ ((interrupt_handler)) asclin1RxISR(); void asclin1RxISR (void)
{
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""asclin1ErISR"",""0"",""12" );extern void __attribute__ ((interrupt_handler)) asclin1ErISR(); void asclin1ErISR (void)
{
 IfxAsclin_Asc_isrError(&ascDriver);
}
# 59 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
_aurix_tc27x_lib_uart_err_t aurix_tc_27x_uart_config_device(IfxAsclin_Asc_Config *uartConfig, uint8 uart_module_id)
{
 _aurix_tc27x_lib_uart_err_t err = uart_ok;
...
# 83 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
_aurix_tc27x_lib_uart_err_t aurix_tc_27x_uart_send_byte(uint8 *byte, Ifx_TickTime timeout)
{
 Ifx_SizeT count = 1;
...
# 100 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
_aurix_tc27x_lib_uart_err_t aurix_tc_27x_uart_send_nbyte(uint8 *byte_array, Ifx_SizeT *cnt, Ifx_TickTime timeout)
{
...
# 116 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
_aurix_tc27x_lib_uart_err_t aurix_tc_27x_uart_receive_byte(uint8 *byte, Ifx_TickTime timeout)
{
 Ifx_SizeT count = 1;
...
# 134 "0_Src/0_AppSw/Tricore/lib/aurix_tc27x_uart_lib.c"
_aurix_tc27x_lib_uart_err_t aurix_tc_27x_uart_receive_nbyte(uint8 *byte_array, Ifx_SizeT *cnt, Ifx_TickTime timeout)
{
