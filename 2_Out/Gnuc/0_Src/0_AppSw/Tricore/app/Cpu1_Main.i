# 1 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c"
# 1 "C:\\workspace\\esw_mcs_hightec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c"
# 17 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c"
...
# 18 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c" 2
...
# 19 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c" 2
...
# 20 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c" 2
...
# 492 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h" 2
...
# 493 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h" 2
...
# 494 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h" 2
...
# 535 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
typedef struct
{
...
# 724 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
extern void IfxQspi_SpiMaster_initChannelConfig(IfxQspi_SpiMaster_ChannelConfig *chConfig, IfxQspi_SpiMaster *handle);
# 745 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
...
# 754 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
extern SpiIf_Status IfxQspi_SpiMaster_getStatus(IfxQspi_SpiMaster_Channel *chHandle);
# 769 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
...
# 820 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
...
# 861 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
...
# 873 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
...
# 23 "0_Src/0_AppSw/Tricore/app/Cpu1_Main.c" 2
...
int core1_main(void)
{
  ...
  IfxQspi_SpiMaster_initModuleConfig(&spiMasterConfig, &((*(Ifx_QSPI *)0xF0001D00u)));
  ...
  spiMasterConfig.base.txPriority = 9;
  spiMasterConfig.base.rxPriority = 13;
  spiMasterConfig.base.erPriority = 30;
 ...
 if (IfxCpu_getMutexStatus(&time_command_mutex_C0_C1)) {
   ...
   IfxQspi_SpiMaster_exchange(&spiChannel_master, &spiTxBuffer_C1[i], &spiRxBuffer_C1[i], 8);
   ...
   memcpy(buffer_C1_C0, spiRxBuffer_C1, 8);


   IfxCpu_acquireMutex(&time_command_mutex_C1_C0);
 }

 memset(&spiTxBuffer_C1, 0, 8);
 memset(&spiRxBuffer_C1, 0, 8);
