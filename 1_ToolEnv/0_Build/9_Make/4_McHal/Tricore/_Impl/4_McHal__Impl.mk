...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEmem_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEmem_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEmem_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxEmem_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxEmem_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '

OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEray_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEray_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxEray_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxEray_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxEray_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '

OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxSmu_cfg.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxSmu_cfg.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_Impl/IfxSmu_cfg.o: 0_Src/4_McHal/Tricore/_Impl/IfxSmu_cfg.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_Impl/IfxSmu_cfg.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
